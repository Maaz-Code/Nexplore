        ...
        <>
            <nav className="navbar navbar-expand-md navbar-dark bg-dark">
                <div className="container-fluid">
                    <NavLink className="navbar-brand ms-4" to="/home">Nexplore</NavLink>
                    ...
                    <div className="collapse navbar-collapse" id="navbarText">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li className="nav-item me-lg-4">
                                <NavLink exact activeClassName="menu_active" className="nav-link" aria-current="page" to="/home">Home</NavLink>
                            </li>
                            <li className="nav-item me-lg-4">
                            ...
                            <li className="nav-item me-lg-4">
                                <NavLink activeClassName="menu_active" className="nav-link" to="/auth">Profile</NavLink>
                            </li>
                         </ul>
                    </div>
                </div>
